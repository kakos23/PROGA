...
//
    ...
    public void run() {
        String line;
        try {
            //while ((line = in.readLine()) != null && (new Date().getTime() - debounce.getTime()) < 60000) { // Для 10-ой лабы
            ...
            //out.println("There's no request during long period of time. Good Bye!"); // Для 10-ой лабы
            socket.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
